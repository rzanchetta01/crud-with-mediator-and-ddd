...
public record UpdatePlayerStatsCommand(PlayerStatsDto TeamDto) : IRequest<ResponseTemplate>;

public class UpdatePlayerStatsHandler : IRequestHandler<UpdatePlayerStatsCommand, ResponseTemplate>
{
    ...
    public async Task<ResponseTemplate> Handle(UpdatePlayerStatsCommand request, CancellationToken cancellationToken)
    {
