...
public record CreateTeamStatsCommand(TeamStatsDto Dto) : IRequest<ResponseTemplate>;

public class CreateTeamStatsHandler : IRequestHandler<CreateTeamStatsCommand, ResponseTemplate>
{
    ...
    public async Task<ResponseTemplate> Handle(CreateTeamStatsCommand request, CancellationToken cancellationToken)
    {
